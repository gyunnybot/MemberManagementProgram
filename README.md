...
회원 가입이 끝나면 return "redirect:/";를 통해 홈 화면으로 돌아갑니다(Redirection). 사용자는 다시 홈 화면으로 이동하게 됩니다.
...
## 업데이트
### 2025-09-01-15:30
- `JdbcMemberRepository` 구현 후 회원 정보가 H2 데이터베이스에 저장되도록 변경
...
### 2025-09-01-19:50
- JdbcTemplate을 활용한 `JdbcTemplateMemberRepository` 구현
- 기존 JDBC API에서의 반복 제거  

### 2025-09-03-11:29
- JPA를 활용한 `JpaMemberRepository` 구현
- Hibernate를 통한 query 자동 생성

### 2025-09-03-11:54
- `SpringDataJpaMemberRepository` 구현

### 2025-09-03-14:19
- `TimeTraceAop` 클래스를 통한 AOP 적용
- 회원 가입 시간, 회원 조회 시간 측정
<img width="826" height="168" alt="image" src="https://github.com/user-attachments/assets/9ac567eb-987b-4526-bee2-1b1907b91ffc" />
